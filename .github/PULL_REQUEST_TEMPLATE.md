...
- [ ] Le mapping JPA (si applicable) est conforme au diagramme UML du sujet
- [ ] Pas de code mort, pas de `System.out.println` oublié
- [ ] Noms de variables / méthodes clairs et en anglais (sauf `couleur` imposé par le sujet)
